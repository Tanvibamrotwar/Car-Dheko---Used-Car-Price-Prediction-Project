...
model = joblib.load("E:\\vscode\\final_random_forest_model1.pkl")
label_encoders = joblib.load("E:\\vscode\\label_encoder.pkl")
scalers = joblib.load("E:\\vscode\\min_max.pkl")  # Assuming this is your loaded scaler for inverse transformation

# Load dataset for filtering and identifying similar data
data = pd.read_csv('E:\\vscode\\cleaned_cardata.csv')
